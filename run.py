...
def get_sales_data():
    ...
    via the terminal, which must be a string of 6 numbers seperarted
    by commas. the loop will repeat until the input is valid.
    """
    while True:
        ...
        data_str = input("Enter you data here:\n") # new line needed to allow input to work
